...
all: 47_4_xlopt 47_4_llopt

47_4_xlopt:
	${CHESSCC} +f +s -p me -P ${CARDANO_AIE_ARCH_MODEL_DIR} +P 4  +Wllvm,-O2,-fno-jump-tables,-fno-discard-value-names,-mllvm,-chess-collapse-struct-types-during-linking=0,-Xclang,-disable-llvm-passes,-g -D__AIENGINE__ -D__AIEARCH__=1 ${INCLUDE_PATH} /var/tmp/Jinming/Charming/one_special/MLP/Work/aie/47_4/src/47_4.cc +Wllvm,-Xclang,-mlink-bitcode-file,-Xclang,ir/K0_mm_kernel0.ll -o ir/47_4_orig.ll;
	${XILINX_VITIS_AIETOOLS}/lnx64.o/tools/clang/bin/opt -S -load-pass-plugin=${XILINX_VITIS_AIETOOLS}/lib/lnx64.o/libLLVMXLOpt.so -passes=xlopt ir/47_4_orig.ll -o ir/47_4.ll 2>47_4/xlopt.log;

47_4_llopt: 47_4_xlopt
	${XILINX_VITIS_AIETOOLS}/lnx64.o/tools/clang/bin/opt -S ir/47_4.ll -o ir/47_4.ll 2>/dev/null;
